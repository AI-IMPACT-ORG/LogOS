...
-- Host wrapper around Agda.Primitive (levels + Lift).
--
-- Provides `Level`, `lzero`, `lsuc`, `_⊔_`, and a minimal `Lift/lift`
-- compatible with usages in this project.
--
...
open Primitive public using (Level; lzero; lsuc; _⊔_; Setω)
