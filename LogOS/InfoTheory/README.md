...
Shannon (finite)
- Facts pack: `LogOS/InfoTheory/Shannon/Facts.agda`
- Core definitions + `KL≥0`: `LogOS/InfoTheory/Shannon/Core.agda`
- Data processing inequality (KL-DPI): `LogOS/InfoTheory/Shannon/DPI.agda`
- Capacity interface + mutual information: `LogOS/InfoTheory/Shannon/Capacity.agda`
- RG/Landauer bridge scaffold: `LogOS/InfoTheory/Shannon/ThermoRG.agda`
