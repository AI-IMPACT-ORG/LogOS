...
{-# OPTIONS --safe #-}
module LogOS.LT.LOG.ArchitectureBulkBoundaryContract2Cat where

-- SpecRef: v5.8 (synchronized with docs/Core/Spec/LogicalTransformers.lagda.md)

-- Bulk-boundary + contract stack over the architectural boundary basis `LOGᴳ`.
...
module Ports {ℓ ℓRel ℓCode : Level} =
  Template.BinarySingletonStackExports
    (BulkBoundary.singleton {ℓ} {ℓRel} {ℓCode})
