...
nontrivialSatF G =
  let
    open Vac.PortVacuityGuards G renaming (sat₀ to satF₀; unsat₁ to unsatF₁)
  in
  p
  , record
      { trueWitness  = φ₀ , satF₀
      ; falseWitness = φ₁ , unsatF₁
      }
...
nontrivialSatF-adapter G =
  let
    open Vac.AdapterVacuityGuards G renaming (sat₀ to satF₀; unsat₁ to unsatF₁)
  in
  p
  , record
      { trueWitness  = φ₀ , satF₀
