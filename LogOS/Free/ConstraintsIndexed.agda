...
{-# OPTIONS --safe #-}
module LogOS.Free.ConstraintsIndexed where

-- ============================================================================
-- SHARED CORE: FREE CONSTRAINT ALGEBRA WITH OPTIONAL ATOMS (INDEXED)
--
-- This module factors the common construction behind:
-- - `LogOS.Free.Constraints`           (no atoms; recovered by taking Atom = ⊥)
-- - `LogOS.Free.ConstraintsOverSig`    (atoms indexed by interface objects)
--
