...
{-# OPTIONS --safe #-}
module LogOS.UniversalIR.While.Examples.CertifiedTranspile where

open import LogOS.Prelude

open import LogOS.UniversalIR.Core using (MinskyCode; EVMCode)
open import LogOS.UniversalIR.While.Compile
open import LogOS.UniversalIR.While.Decompile
open import LogOS.UniversalIR.While.Examples.Factorial using (n₅; outM₅; outE₅; outM₅≡outE₅; outM₅≡120; outE₅≡120)
