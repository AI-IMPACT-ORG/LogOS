...
{-# OPTIONS --safe #-}
module LogOS.UniversalIR.While.Theorems where
...
open import LogOS.UniversalIR.While.Language
open import LogOS.UniversalIR.While.Semantics
open import LogOS.UniversalIR.While.Compile

open import LogOS.UniversalIR.Languages.Minsky as Minsky using (fuelMul; fuelInnerMul; fuelRestoreMul; perIterMul)
