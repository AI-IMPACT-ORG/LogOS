...
{-# OPTIONS --safe #-}
module LogOS.UniversalIR.Examples.QuantumOracle where
...
open import LogOS.UniversalIR.Schemes using (QuantumOracleProcess; meas; meas-zero; meas-+; budget₂; meas≤budget₂; QSteps)
...
qoInterface : Cat.Interface QuantumCode QuantumOracleProcess
qoInterface = record { compile = (λ q → q) ; fuel = (λ _ → 1) }

qoScheme : Sch.Scheme QuantumCode ℕ
qoScheme = Cat.schemeFromInterface QuantumOracleProcess qoInterface
...
qoInterface2 : Cat.Interface QuantumCode QuantumOracleProcess
qoInterface2 = record { compile = (λ q → q) ; fuel = (λ _ → 2) }

qoScheme2 : Sch.Scheme QuantumCode ℕ
qoScheme2 = Cat.schemeFromInterface QuantumOracleProcess qoInterface2
