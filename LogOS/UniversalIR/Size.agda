...
{-# OPTIONS --safe #-}
module LogOS.UniversalIR.Size where

open import LogOS.Prelude

open import LogOS.UniversalIR.Task as Task using (PATask)
open import LogOS.UniversalIR.Encoding as Enc using (natToBits; length)
open import LogOS.UniversalIR.Core.Minsky using (MinskyCode; prog; pc; r0; r1; r2; r3)
open import LogOS.UniversalIR.Core.Lambda using (LambdaCode; Term; term; var; lam; app)
open import LogOS.UniversalIR.Core.Ethereum using (EVMCode; code; stack; pc)
open import LogOS.UniversalIR.Core.QuantumOracle using (QuantumCode; prog; oracle; pc; r0; r1; r2; r3)
open import LogOS.UniversalIR.Core.QuantumCircuit using (QuantumCircuitCode; prog; pc; outLen; wires)
open import LogOS.UniversalIR.Core.UCode using (UCode; UM; UL; UE; UQ; UQC)
