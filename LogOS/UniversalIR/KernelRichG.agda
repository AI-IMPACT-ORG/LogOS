...
{-# OPTIONS --safe #-}
module LogOS.UniversalIR.KernelRichG where

open import LogOS.Prelude

open import LogOS.UniversalIR.Core using (UCode; UM; stepU; simulate)
open import LogOS.UniversalIR.Core.Minsky using (mkM)
