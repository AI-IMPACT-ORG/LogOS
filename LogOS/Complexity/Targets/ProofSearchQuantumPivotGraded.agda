...
{-# OPTIONS --safe #-}
module LogOS.Complexity.Targets.ProofSearchQuantumPivotGraded where
...
import LogOS.Complexity.Targets.ProofSearchGraded as PS
import LogOS.Complexity.ResourceSchemaGraded as QTB
