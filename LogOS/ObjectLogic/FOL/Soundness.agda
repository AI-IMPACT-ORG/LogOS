...
{-# OPTIONS --safe #-}
module LogOS.ObjectLogic.FOL.Soundness where
...
import LogOS.ObjectLogic.FOL.Semantics
open import LogOS.ObjectLogic.FOL.ND
...
module _ {ℓΣ ℓ : Level}
  ...
  open LogOS.ObjectLogic.FOL.Semantics.For D PredI RelI
