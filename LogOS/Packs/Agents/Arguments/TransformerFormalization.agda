...
{-# OPTIONS --safe #-}
module LogOS.Packs.Agents.Arguments.TransformerFormalization where
...
import LogOS.Packs.Agents.Arguments.TransformerScaling as TransformerScaling
...
module For
  ...
  open RG using (Policy; RGStep; RGStable; ScalingDimension; applyRG; rg-μ; rg-unfold-right)
  ...
  mu-stable {D = D} conv =
    record { closed = rg-unfold-right (step D) (scott conv) }
