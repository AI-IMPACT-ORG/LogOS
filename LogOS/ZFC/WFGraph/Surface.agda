...
{-# OPTIONS --safe #-}
module LogOS.ZFC.WFGraph.Surface where

open import LogOS.Prelude
open import LogOS.API.Kernel using (kernelLike-fromKernel)

open import LogOS.ZFC.SetTheory.ChoiceAxiom as AC using (AxiomOfChoice)
open import LogOS.ZFC.SetTheory.Dsl using (ZFDsl)
open import LogOS.ZFC.SetTheory.FormulaFromDefinable as FromDef using (toZFAxiomsᶠ)
...
import LogOS.ZFC.WFGraph.FormulaPack as Formula
import LogOS.ZFC.WFGraph.Textbook as Textbookₜ
