...
open import LogOS.Domain.UniversalIR.Languages.QuantumOracle as QO
open import LogOS.Domain.UniversalIR.Languages.QuantumCircuit as QC
...
open import LogOS.Domain.UniversalIR.Theorems as Thm
...
(`LogOS.Domain.UniversalIR.Theorems`). The λ backend is now certified by
...
see `LogOS/Domain/UniversalIR/Examples/Convincing.agda` (Minsky ≡ EVM for all `PATask`).
