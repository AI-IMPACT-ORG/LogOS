...
{-# OPTIONS --safe #-}
module LogOS.Domain.UniversalIR.TheoremsExpr where
...
open import LogOS.Domain.UniversalIR.Task using (PAExprTask; evalExprTask)
open import LogOS.Domain.UniversalIR.Std using (decodeChurch-church)
open import LogOS.Domain.UniversalIR.Encoding as Enc using
  ( natToBits; length; take; bitsToNat; take-length; bitsToNat-natToBits )

import LogOS.Domain.UniversalIR.Schemes as USch
