...
{-# OPTIONS --safe #-}
module LogOS.Domain.SetTheory.Pack where
...
-- - `LogOS.Domain.SetTheory.DefinablePack` for coded/definable schemata.
-- - `LogOS.Domain.SetTheory.FullUpgradeFromDefinable` to upgrade definable → full.
-- - `LogOS.Domain.SetTheory.CumulativeSurface.stageToSurface` to obtain a `ZFDsl` from
--   a cumulative hierarchy; use `LogOS.Domain.SetTheory.LimitPack.toZFAxioms` to recover
