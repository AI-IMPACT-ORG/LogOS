...
{-# OPTIONS --safe #-}
module LogOS.Domain.SetTheory.DefinablePack where
...
-- predicates/functions), use `LogOS.Domain.SetTheory.FullUpgradeFromDefinable`
-- to make the needed “representability by codes” assumptions explicit.
-- In this repository, the corresponding module is `LogOS/Domain/SetTheory/FullUpgradeFromDefinable.agda`.
--
-- We keep the same core surface as `LogOS.Domain.SetTheory.Pack.ZFAxioms`,
