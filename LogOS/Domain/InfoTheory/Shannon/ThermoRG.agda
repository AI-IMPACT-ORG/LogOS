...
{-# OPTIONS --safe #-}
module LogOS.Domain.InfoTheory.Shannon.ThermoRG where
...
-- - the physics layer (energy/cost) can live in a quantale scale elsewhere,
...
module QuartetThermoRG where
  ...
  mkPack A =
    Q.mkPack
      (λ A → let module W = With A in W.EP→Cost)
      A
