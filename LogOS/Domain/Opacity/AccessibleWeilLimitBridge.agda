...
{-# OPTIONS --safe #-}
module LogOS.Domain.Opacity.AccessibleWeilLimitBridge where
...
module QuartetLimitBridge
  ...
  mkPack A = record { claim = GRH_Without_Vacuity_Guards_from_AccessibleWeilLimitBridge {ℓC = ℓC} K RS A }
