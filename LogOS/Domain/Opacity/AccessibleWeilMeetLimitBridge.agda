...
{-# OPTIONS --safe #-}
module LogOS.Domain.Opacity.AccessibleWeilMeetLimitBridge where
...
module QuartetMeetLimitBridge
  ...
  mkPack A = record { claim = GRH_Without_Vacuity_Guards_from_AccessibleWeilMeetLimitBridge {ℓC = ℓC} K RS A }
