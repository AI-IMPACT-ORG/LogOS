...
This Agda library, combined with extensive CI checks for vacuity and correctness, as well as with grounding documentation forms an effective development environment for human-AI collaboration to develop formal models of basically anything. 
