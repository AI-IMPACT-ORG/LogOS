...
This Agda library forms an effective development environment for human-AI collaboration to develop formal models of basically anything that can be modelled in code. It relies on some pretty fundamental and interesting mathematics, but can already be used today. 
